...
//     int dve = 200;
//     {
//         for(int sem = 17; dve % sem !=0; dve++);
//     }
//     return dve;
// }
// int maxN = MaxN();
// System.Console.WriteLine($"{maxN} - наименьшее число которое нацело делится на 17");
...
//     int five = 5000;
//     {
//         for(int fri = 39; five % fri !=0; five--);
//     }
//     return five;
// }
// int max2 = Max2();
// System.Console.WriteLine($"{max2} - наибольшее число которое нацело делится на 39");
